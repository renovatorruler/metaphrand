// KukuEp10_Blender.res — the «द से दीया» courtyard, emitted as scene JSON for Blender.
//
// EP10 is ONE place for all thirty shots, so the set is built once here and every
...
//
// CONVENTIONS carried over from the ग-से-गाय rig, each of which cost a bad render to learn:
...
//
//   node src/KukuEp10_Blender.res.mjs        # writes ep10prod scene json
...
let outDir = cwd() ++ "/../stories/kuku/ep10/sets/blender/"
