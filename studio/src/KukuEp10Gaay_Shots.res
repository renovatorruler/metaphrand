/* KukuEp10Gaay_Shots.res — all 52 EP10 hero setups authored against the story
   ...
   Run from studio/:
     node src/KukuEp10Gaay_Shots.res.mjs                      # render the doc, generate nothing
     node src/KukuEp10Gaay_Shots.res.mjs go h01_ring_wide ... # regenerate named shots via the spec
...
let header =
  ...
  "Rendered by `studio/src/KukuEp10Gaay_Shots.res`. Each shot declares its story BEAT; `Kuku_Ep10State.res` derives गौरी's place, great/small form, the lighting clock, and whether the golden ग-shape exists (using it before the forging is a render-time error). These facts live in ONE module and cannot be forgotten per shot.\n\n" ++
