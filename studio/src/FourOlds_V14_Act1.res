    ...
    [
      {
        ...
        wall: "Stitch exists",
        turn: "his roll call names the thing plainly for anyone on Earth — Apollo Eighteen, lunar descent rehearsal, number two thousand eight hundred and six — and the men fall in behind it, to a point, never fully, which is also the standard",
        subtext: "order as affection; the count is the vow said out loud",
      },
      {
        who: "STITCH",
        want: "to tell the net about something that has nothing to do with the Moon — pick ONE concrete mundane tangent (a neighbor's estate auction, a bad casket at a funeral, somebody's new hip) and let him work it",
        wall: "checklist discipline, personified in Gunny",
        turn: "told to keep the net clean, he answers with some version of the truth that after fifty years of Tuesdays the Moon is not going to sneak up on anybody — in HIS drawl, not those words — and keeps right on talking, and the descent goes on underneath him anyway",
        subtext: "the tangents are not interruptions of the ritual; they are the ritual",
      },
      {
        who: "DUTCH",
        want: "the Bus B fault taken seriously, and the record to show he called it",
        wall: "it is a forty-year-old relay and every man on the net has heard about it for years",
        turn: "the fault actually walks mid-descent — needle wandering, buzz stuttering — and his fix crosses three states by ear: kick it, low left corner; the kick lands, the needle climbs home, nobody says one word of credit, and Dutch takes his vindication in one dry line and lets it go",
      ...
      },
      {
        ...
        turn: "he flies THROUGH the chatter, readouts threading between tangents — and at three hundred feet the net goes quiet on its own, nobody calls for it, fifty years of knowing when to shut up — CONTACT light — 'Contact light. Engine stop.' — the beat of quiet — then Stitch's throttle critique and Gunny's 'The man is on the ground, Colonel.'",
        subtext: "the landing matters because the talking stops for it",
      },
    ],
    [
