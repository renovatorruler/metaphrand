...
let jobs: array<job> = [
  ...
  mk(
    ...
    "The barn reveal: a real Apollo procedures trainer kept flying for fifty years by one man's hands, and the Tuesday-night radio net that crews it — ending in a log entry, a padlock, and a walk to a dark farmhouse.",
    [V14Cast.cricket, V14Cast.dutch, V14Cast.stitch, V14Cast.gunny],
    "an old man runs a flight-simulator drill in his barn while three old friends crew it by ham radio",
    "this is a congregation, not a hobby — fifty years of Tuesdays kept like a vow nobody ever asked him to keep; the movie's whole argument about habit, faith, and readiness lives in this room and nobody in it would use any of those words",
    [
      {
        who: "CRICKET",
        want: "fly the Tuesday drill clean, per the card",
        wall: "a forty-year-old electrical fault mid-descent — the needle walks, the buzz stutters",
        turn: "Dutch diagnoses it by ear across three states — 'Kick it, low left corner.' — the kick lands, the needle climbs, and nobody says one word about it; the drill continues to a contact light",
        subtext: "competence as intimacy; the fix IS the friendship",
      },
      {
        who: "STITCH",
        want: "needle the commander",
        wall: "the man just landed clean, again",
        turn: "'Hair late on the throttle there at the end.' — and Gunny: 'The man is on the ground, Colonel.'",
        subtext: "love, administered as critique",
      },
    ],
    [
      ...
      "REQUIRED net texture: 'Net's open. Tuesday, nineteen-oh-two local.'; Dutch on the Bus B sag and the relay he put in in '84 ('I'm allowed to say it.'); Gunny keeping time ('It's nineteen-oh-three, gentlemen. Commander, run your checklist.'); the descent — needle walking, 'Steady or does it stutter?', the kick; contact light — 'Contact light. Engine stop.'; the beat of quiet; Stitch's throttle needle and Gunny's answer; 'Net closed. Same time Tuesday.' / 'God willing.'; the two-click sign-off answered twice around; the fresh page in ballpoint block letters: T+2,806. BUS B CORRECTED. CONTACT 19:41. CREW PRESENT BY RADIO.; the thumb run down the dated spines; the padlock tested with one pull; the farmhouse porch light beyond, and Cricket crossing to a house with no lights on inside.",
  ...
  /* ---- v05 PELL & HOLLOWAY --------------------------------------------- */
  mk(
    "v14-05-pell-holloway",
    "sc05_pell_holloway.scene.txt",
    "INT. FEDERAL COMPLIANCE FIELD OFFICE - DAY",
    "Pell, four verified recoveries against a regional average of eleven, takes a dashboard beating from Holloway — the President's office pulled the regional list by name — and reaches for the one parcel on his sheet that can move a number by Saturday: a farm with undeclared aerospace hardware, flagged by the Accord's federal asset list. He pulls a folder tabbed DAWES / FRONTIER.",
    [V14Cast.pell, V14Cast.holloway],
    "a middle manager gets threatened with a spreadsheet and picks his next case",
    "the machine's cruelty is nobody's malice — it is a thin column on a dashboard and a man afraid of it; the seizure that wounds Cricket is born here as arithmetic",
    [
      {
        who: "HOLLOWAY",
        want: "his region's column thicker before Saturday's live board",
        wall: "Pell's numbers are what they are",
        turn: "he names the stakes — the President's people watching, regions he could move people into — and hangs up mid-sentence for another call",
        subtext: "pressure rolls downhill in units of column-width",
      },
      {
        who: "PELL",
        want: "prove eleven years of clean closures still count",
        wall: "the board only counts verified, and verified is slow",
        turn: "he mutes the call to hold a subordinate's close-out for Saturday's count, then commits to the north parcel himself — and pulls the DAWES / FRONTIER folder flat under the light",
        subtext: "a decent-adjacent man learning to cook his own numbers one degree at a time",
      },
    ],
    [
      "REQUIRED texture: the wall map stuck with red pins; the commendation photo dated two years old; the video call hanging a half second behind the sound; 'Four verified, against a regional average sitting around eleven, and the broadcast's Saturday.'; 'The board's not counting anything that's still down at the lab.'; 'The President's office pulled the regional list themselves this week. They asked for yours by name.'; the radio interruption (unit two-oh-four clearing the Halvorsen parcel) and Pell's whispered 'Hold the Halvorsen close-out, don't file it yet, I want it on Saturday's count.'; the call window closing before Pell finishes his sentence.",
      "The Dawes parcel arrives via the FEDERAL ASSET LIST — anything the Accord can call aerospace, flagged statewide. No informant, no tip, no mystery: a list printed the hardware's existence years ago (a surplus trainer never returned). Pell says it plain: it's the kind of thing that verifies.",
      "END: the folder from the standing rack, tab reading DAWES / FRONTIER, laid open flat on the desk under the light.",
    ],
  ),
  /* ---- v06 THE SEIZURE -------------------------------------------------- */
  mk(
