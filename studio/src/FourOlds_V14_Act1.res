...
let jobs: array<job> = [
  ...
  mk(
    ...
    "Tuesday night at the Dawes barn: four old men gather in person, as they have for fifty years, and run lunar-descent rehearsal number 2,806 with the seriousness of a varsity program — headsets on in the same room for the drill, percolator and folding chairs for the after. The talk builds to the thing that makes them remarkable: they are scouting the sport that forgot them, and they are unimpressed.",
    [V14Cast.cricket, V14Cast.dutch, V14Cast.stitch, V14Cast.gunny],
    "four old friends meet at a barn every Tuesday and run their Moon-landing rehearsal together — trucks up the drive, headsets during the descent, coffee and argument after",
    "varsity in a barn: elite-crew professional pride, fully intact, inside men the world reads as cute — they review real astronauts like retired coaches watching film, and the audience slowly realizes the arrogance is EARNED; the scene ends with the trucks gone and one man alone in a dark yard, and nobody has said one reverent word",
    [
      {
        who: "GUNNY",
        want: "the drill run to the standard — headsets on, comms discipline, between men eight feet apart",
        wall: "the men are eight feet apart and know it",
        turn: "his roll call opens the drill with full ceremony — 'Apollo Eighteen. Lunar descent rehearsal. Number two thousand, eight hundred and six.' — and he enforces loop protocol ('Say again.') on a man he can hear breathe; the solemnity at that scale is the joke, nobody laughs, and the drill is BETTER for it, which is the bigger joke",
        subtext: "the unit's standard survives anything, including proximity",
      },
      {
        who: "STITCH",
        want: "to relitigate this week's real space news — a current mission's landing they all watched — as a man personally insulted by it",
        wall: "Dutch, who has the actual figures written down",
        turn: "the film review runs THROUGH the drill: modern crews fly with a computer holding both hands, the landing they watched came in long, 'and that fella's got a patch and a parade' — Dutch corrects the how-long figure from his ledger, the correction changes nothing about the verdict, and the verdict is unanimous: not one of those boys would have cleared Dutch's physical",
        subtext: "retired varsity scouting the league that forgot them — the arrogance surfacing as sports talk",
      },
      {
        who: "DUTCH",
        want: "the Bus B fault taken seriously, and the record to show he called it",
        wall: "it is a forty-year-old relay, everyone has heard about it for years, and gloating is beneath his standard",
        turn: "the fault walks mid-descent — and Dutch, across the room, not looking up from his ledger: 'Kick it. Low left corner.' — the kick lands, the needle climbs home, and Dutch's attempt NOT to gloat fails by exactly one dry sentence",
        subtext: "he doesn't need to look; fifty years of noticing IS the intimacy",
      },
      {
        who: "CRICKET",
        want: "fly the card, clean, through all of it",
        wall: "his crew's noise — which he would not trade for silence",
        turn: "he flies THROUGH the sports talk, deadpan readouts punctuating other men's arguments — at three hundred feet the room goes quiet on its own, nobody calls for it — CONTACT light — 'Contact light. Engine stop.' — one beat of real quiet, the scene's single earned spike — and then the comedy is back inside two lines: the crew appraises HIS landing with the same scouting eyes they turned on the television, and it grades out clean, which nobody says warmly",
        subtext: "his landing is the argument they've been making all night, demonstrated",
      },
    ],
    [
      "FULL PLAYING — three to three and a half pages. IN PERSON, one barn: trucks up the drive at the top (headlights across the wall, who brings what), the drill in the middle, coffee and argument after, and the taillights leaving at the end — Cricket alone in the yard, the padlock, the dark farmhouse. The film-review argument and the drill BRAID line by line: an altitude call landing in the middle of the scouting verdict is the scene working.",
      "THE HEADSET GAG, established plainly and played straight: during a descent they wear headsets in the same room — that is how real simulator sessions run, and Gunny enforces loop discipline on men he can hear acoustically. Drill voice versus room voice is a running comic engine: headsets ON = procedure; headsets OFF = the argument resumes at room volume.",
      "OPEN on the trainer reveal per the calibration example in studio/SCREENPLAY_STYLE.md — the pull-cord CLICK, the APOLLO PROCEDURES TRAINER, hand-machined gauges, the crew couch in a welded cradle, the triangular window, the painted Moon on the barn wall, then ALONG THE BACK WALL -- the spiral notebooks floor to roof, every spine dated in the same block hand, the first shelf starting in 1972 — and folding chairs, a percolator, a card table: the room is HALF flight facility, HALF clubhouse, and nobody sees a contradiction.",
      "THE VARSITY ENGINE (what the talk builds to): they review a real, current mission from this week's news like retired coaches scouting film — specific, technical, unimpressed, personally affronted — and the audience slowly understands these men consider themselves, without one flicker of doubt, the best who ever trained for this. The scene never argues with them. Cricket's clean landing at 2,806 is the silent proof. NOBODY says anything reverent about it.",
      ...
      "REQUIRED kept beats: the Bus B relay history ('I'm allowed to say it.' energy, a grievance with a date on it); the mid-descent fault — needle walking, 'Steady or does it stutter?', 'Kick it. Low left corner.' from a man not looking up, the kick, the needle home, one dry almost-gloat; the silence arriving on its own from three hundred feet; contact light — 'Contact light. Engine stop.'; the beat of quiet; 'Net closed. Same time Tuesday.' / 'God willing.'; the fresh page in ballpoint block letters: T+2,806. BUS B CORRECTED. CONTACT 19:41. CREW PRESENT.; the thumb run down the dated spines; the padlock tested with one pull; taillights down the drive, and the farmhouse beyond with no lights on inside.",
      ...
      "Nobody mentions Peg. The empty house says it. NO ham-radio-to-far-places framing anywhere — all four men are IN the barn.",
    ],
  ),
  ...
  mk(
    ...
    [
      ...
      "THE MIRROR, staged to be quoted: Cricket's stand happens in the barn DOORWAY — he plants himself square in it, feet set, hands at his sides, between the government and the thing he keeps. Hold the image one beat before Wade comes. Wade takes his arm with both hands, gently, and walks him three steps aside — and Cricket lets him, because it's Wade. The dolly rolls past; his eyes never leave the couch. This exact posture, framing, and cadence will be quoted at Tranquility in Act 3 — build it clean so the quote lands.",
  ...
  mk(
    ...
    "INT. DAWES BARN - NIGHT",
    "Around the barn stove that night, the crew wants to answer the seizure with a big loud middle finger: mortar shells over the compliance office's empty lot. Cricket says no — he has a grandson. Three old men do it anyway, get cited by Wade, plead guilty to Judge Benning, and get time served plus the cost of the gravel. Cricket is waiting at the bottom of the courthouse steps to drive them home.",
  ...
  mk(
    ...
    [
      ...
      "THE CONVERT ANGLE doubles the room's relief: they are sending the office Europhile to do Europe's work — the one man who will thank them for it. Pell's Brussels-fellowship reverence (per his card) colors his gratitude; nobody in the room shares it.",
