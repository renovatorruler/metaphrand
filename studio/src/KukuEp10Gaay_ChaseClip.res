/* KukuEp10Gaay_ChaseClip.res — one Seedance 2.5 test: does MOTION carry the chase
   ...
   Run from studio/:
     node src/KukuEp10Gaay_ChaseClip.res.mjs            # print the prompt + price it
     node src/KukuEp10Gaay_ChaseClip.res.mjs --go       # spend and download */
