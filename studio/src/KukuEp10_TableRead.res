// KukuEp10_TableRead.res — the «द से दीया» table read.
//
...
//
//   node src/KukuEp10_TableRead.res.mjs          # synth missing takes, then assemble
//   node src/KukuEp10_TableRead.res.mjs --dry    # list the lines and their voices
