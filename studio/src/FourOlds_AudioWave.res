...
let units: array<(int, string, string, array<Seed.voiceCard>, string)> = [
  ...
  (3, "sc28_sendoffs.scene.txt", "29", [V14Cast.cricket, V14Cast.danny, V14Cast.tito, V14Cast.lita], "Danny's county line and 'I am a farmer.'; the ZINNIA plays under the self-talk law in Cricket's plain register — the pocketknife through old stitches, the paper-dry rustle, and his few words of spoken discovery, his way, never gushing; Lita's Singer, scissors, the pin through cloth, a kiss, a screen door — nearly wordless and fully audible."),
  (3, "sc29_weigh_in.scene.txt", "30", [V14Cast.pell, V14Cast.mack, V14Cast.joss, V14Cast.scaleTech], "The scale's servo hum; numbers read flat; cell three tapped twice with two knuckles; Pell savoring kilograms (his sacrament); the tag dropped into the holder and one camera shutter."),
  (3, "sc30_loadout.scene.txt", "31", [V14Cast.cricket, V14Cast.gunny, V14Cast.joss, V14Cast.tito, V14Cast.mack, V14Cast.danny, V14Cast.dockworker], "4 AM gate; torque guns; knock checks down the line; THE DOCKWORKER's three seconds = breath, a latch, held air, and a man muttering block letters as he writes: 'All… clear.' — may be stronger blind than on film. Gate guard cast in-scene."),
  ...
  (4, "sc36_empty_sites.scene.txt", "37", [V14Cast.brandt, V14Cast.lindqvist, V14Cast.shen, V14Cast.streamer, V14Cast.buck, V14Cast.earlene], "Cue-card paper in glove fingers; 'The artifact is… not present.'; the streamer's donation chimes and caps-lock joy; Buck's slow smile arrives purely in his voice."),
  (4, "sc37_reveal.scene.txt", "38", [V14Cast.brandt, V14Cast.lindqvist, V14Cast.shen, V14Cast.buck, V14Cast.earlene, V14Cast.gunny, V14Cast.streamer], "THE CENTERPIECE — the described image: Brandt's climb as breath and boot-crunch on comms; the loop silent one beat too long; then Earth sees it FOR us in this order — a controller's half-sentence dying, Roy's ('Where's Earl and them?…' / 'There they are.'), the panelist identifying the suits, BRANDT reading the four crate stencils aloud on the open loop (the title landing by voice), Warsaw clapping around one phone. Nobody describes prettily; every voice in its own register."),
  (4, "sc38_standoff.scene.txt", "39", [V14Cast.brandt, V14Cast.cricket, V14Cast.stitch, V14Cast.gunny, V14Cast.shen, V14Cast.lawyer1, V14Cast.lawyer2], "Natively audio: an argument on an open loop the world is on. The lawyers on speakerphone timbre. Stitch's line lands from a seated voice — lower, effortful, and the ear can tell. 'We came in the mail.' verbatim."),
