...
let img = Path(dir ++ "/mitasur_talk_900.jpg")
let aud = Path(dir ++ "/mitasur_A_vardan.mp3")
let out = Path(dir ++ "/MITASUR_TALK.mp4")

let main = async () => {
  Js.log("=== OmniHuman papercraft-dragon test: Mitasur monologue (Vardan, 9.8s) ===")
  switch await falOmnihumanUrl(~imageUrl="https://dustys-mac-studio.tail9e29c.ts.net:10000/kukuvid/mitasur_talk_900.jpg", ~audioUrl="https://dustys-mac-studio.tail9e29c.ts.net:10000/kukuvid/mitasur_A_vardan.mp3") {
  | clip => {
