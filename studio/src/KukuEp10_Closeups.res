// KukuEp10_Closeups.res — a close single on the speaker, one per spoken line.
//
...
//
//   node src/KukuEp10_Closeups.res.mjs list
//   node src/KukuEp10_Closeups.res.mjs one <n>
//   node src/KukuEp10_Closeups.res.mjs all
...
let doOne = (i, c) =>
  ignore(Kuku_Engine.still(~episode="EP10", ~id=idOf(i, c), ~spec=specOf(c), ~dst=pathOf(i, c), ()))
