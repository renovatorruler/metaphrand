/* KukuEp10Gaay_SetBible.res — build EP10's set bible from Kuku_Ep10Sets data.
   ...
   Run from studio/: node src/KukuEp10Gaay_SetBible.res.mjs blueprint */
...
| (m, _) =>
  Js.log(
    "usage: node src/KukuEp10Gaay_SetBible.res.mjs <blueprint|plate|survey|prompt> <lane|courtyard|flat_stone|tower|doorway|grass_verge>  (got: " ++
    m ++ ")",
  )
}
