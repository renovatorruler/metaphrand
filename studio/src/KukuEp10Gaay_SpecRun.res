/* KukuEp10Gaay_SpecRun.res — EP10 review-notes round 1, run through the JSON prompt law.
   ...
   Run from studio/ after `npm run build`:
     node src/KukuEp10Gaay_SpecRun.res.mjs            # dry — print prompts + refs, spend nothing
     node src/KukuEp10Gaay_SpecRun.res.mjs go-s011    # nano_banana_pro edit
     node src/KukuEp10Gaay_SpecRun.res.mjs go-s014    # seedance_2_0_mini clip */
