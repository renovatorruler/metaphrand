# «Фрося и Вася» — v5: the origin story and the rebuilt magic (author-designed, 2026-07-31)

Status: v5 REPLACES all previous magic-system designs (v4's mechanic section, the read-then-say gates, the summoning mode, the minimal-pair engine — all dead). The world, creatures, cast, visual canon, native-Russian law, evergreen-song law, and radio-play format from earlier docs STAND. This document is the author's own design, assembled: the backstory, the two wishes, mom's condition, and the laws that follow.

## THE BACKSTORY (why each kid wants what they want)

ФРОСЯ WANTS THINGS. She spies through the floor-cracks on the giants' children and their new toys — shiny, whole, boxed, THEIRS. Домовята own only what the house lets fall: hand-me-downs, lost things, broken things, forgotten things. Nothing new has ever belonged to her. So she begs. Constantly. For real, new, shiny things.

ВАСЯ WANTS TO BE SOMETHING COOL. A dinosaur that turns into an airplane that turns into a robot. He is a dopey, warm, dream-soaked kid who wants transformation itself — not to have the cool thing, to BE the cool thing.

They pester мама about it endlessly. She has the same answer every time: we have everything we need. (She is right, and it changes nothing, because they are children.)

## THE GRANTING (episode 1's spine)

БАБА-ЯГА IS МАМА'S MOTHER. The kids' grandmother — the wild branch of the family, who long ago left the houses for the forest. On Фрося's birthday she visits, arriving THROUGH THE STOVE (the hearth is the old door between the house-world and the wild; she is one of the few old enough to use it). Her chicken-legged hut waits in the yard, small as a birdhouse, pecking at the gravel.

And she does what grandmothers do: she spoils. Where мама said no, бабушка says «а почему бы и нет». She grants both wishes:

- ФРОСЯ gets THE MAGIC PENCIL: what she draws becomes real.
- ВАСЯ gets the ВЖУХ: he can transform into anything.

WITH GRANDMOTHER'S CATCH (she is still Баба-Яга; her gifts always have a hook): THE GIFTS ONLY WORK TOGETHER. Neither power is complete alone — that is baked into the magic itself, her mischief and her wisdom in one clause.

THEN МАМА GETS THE FINAL WORD (the Sleeping-Beauty structure — the last gift modifies the others). She will not raise spoiled wizards; she wants readers. Her condition: THE POWERS OBEY ONLY LETTERS FROM HER СУНДУК. Яга herself hands her the letter-chest — the elder arming the mother: «А тебе, хозяйка, — вот это. Пригодится.»

ДЕД: Яга's husband is ЛЕШИЙ, the forest keeper. Mentioned warmly from episode 1 — «мой старик лес сторожит, его из чащи не выманишь» — he cannot leave the forest (someone must mind the trees). He appears in a later season when the geography reaches him. No single-grandma reading; no extra character to service now.

ПАПА is present throughout — the son-in-law hosting Баба-Яга is its own comedy: the teasing тёща-и-зять relationship, and when the gifts get loud he backs мама's rule with a joke, never a lecture. The family always reads whole.
...
### ВАСЯ — THE ВЖУХ
He reads a written word aloud AND CRIES «ВЖУХ!» — and becomes it (the cry is the trigger, spoken by him, not a sound effect). Crying «ВЖУХ!» again returns him to himself; breaking the written word (wipe it, scatter the chips) also returns him. One word at a time. He can only read words built from letters he has learned. CONTINUITY CONSEQUENCE: he cannot transform where there is nothing to read — a cat trapped under a бак must ВЖУХ back to a boy, crawl out, and only then lay out a new word.
...
WHAT DIES WITH v5: the two-mode read magic (summon vs become), the air-written glowing words as Фрося's power, minimal-pair gags and their reserved episodes, the «Скажи — и стань» granting-free mechanic (the chant may survive as the kids' own battle cry, author's call), and the Бобуквы-order-as-external-ladder (the order now lives диegetically in мама's dispensing pace — the author's real teaching order still governs WHICH letter comes next, and the book-unlock loop still works at home).

## EPISODE 1 — «ДЕНЬ РОЖДЕНИЯ» (beat sheet for approval)

1. COLD OPEN — the sock haul, kept, now doing double work: mid-errand, Фрося stops at a floor-crack of light and SPIES — the giant children, a new toy, the shine of it. Вася has to pull her away. No one explains anything; when he asks why the giants get new things, her answer is a house-fact: «Так дом устроен.» And it is her birthday — she mentions it for the fortieth time.
2. BIRTHDAY MORNING behind the stove — hand-me-down presents, warm and worn: something mended by папа, something sewn by мама. Фрося is grateful and it is not enough and both are true. The begging duet crests: she wants a real NEW thing; he wants to be a robot-dinosaur. Мама: «У нас есть всё, что нам нужно.»
3. WIND IN THE CHIMNEY. Soot falls. БАБУШКА steps out of the stove. (Outside, the hut settles in the yard, small as a birdhouse.) Joy, chaos, папа's теща-jokes, babies passed around. Mid-hubbub, quietly: «мой старик лес сторожит…» — дед exists.
...
1. The go to write the full script from this beat sheet.
2. Фрося's season dream object: ВЕЛОСИПЕД recommended; her call.
3. Does «Скажи — и стань!» survive as the kids' battle cry at interlock moments, or retire entirely?
4. The challenge in beat 8: the collapsing cake table (recommended), or another birthday-scale crisis of your choosing.
