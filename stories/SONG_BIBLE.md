...
| Songbook / माटी माँगे candidate | `एक आँगन में दो राजा` exploration | **STANDING BUT PARKED** — return soon | Two-kings architecture retained; rain rejected, काल too dark; unnamed crownless charioteer is the leading parked second-king candidate | [latest preserved retreat lyric](songbook/2026-08-02_SONG_aaj-dera-us-paar.md) |
| Songbook / family | `नाम हैं या गीत?` | **ACTIVE DRAFT v2** — author verdict, native-ear, and name-spelling pass required | Hindi / raw Malwa genealogical bard; dry page-too-small joke; names intact and ordered; no Gita coda | [family-lineage song](songbook/2026-08-02_SONG_naam-hain-ya-geet.md) |
