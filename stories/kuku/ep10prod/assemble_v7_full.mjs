...
const B = P + "v7_table_read/build_full/"; fs.mkdirSync(B, { recursive: true });
...
const CUE_MEDIA = { S011: { img: S + "s011_castor_calm_solo.png" }, S014: { video: P + "clips/S014_furia_ring_flight.mp4" } };
...
execFileSync("ffmpeg", ["-v", "error", "-y", "-i", B + "picture.mp4", "-i", B + "dialogue.m4a",
  ...
  "-movflags", "+faststart", "-shortest", P + "EP10_V7_REVIEW_NUMBERED.mp4"], { timeout: 1800000 });

fs.writeFileSync(P + "EP10_V7_SHOTLIST.md",
  "# EP10 V7 — full cut shot list (S### dialogue, A## action/sound)\n\n| # | at | who | scene | frame |\n|---|----|-----|-------|-------|\n" + rows.join("\n") + "\n");
console.log(`EP10_V7_REVIEW_NUMBERED.mp4 — ${beats.length} beats, ${t.toFixed(1)}s`);
