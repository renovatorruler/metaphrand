# कुकु और अक्षर — Voice Cards

*Per-character voice spec. The engine's `Seed.voiceCard` (name / who / register / earnsEloquence / lexicon) is filled from these. **The gate is blind attribution:** strip the cue, read the Hindi cold — any line that fits two dragons gets re-voiced. For this show the axes are tuned for **preschool clarity**, not adult subtext.*

### कुकु (Kuku) — `kuku` · *the littlest dragon, who breathes letters*
- **Sentence:** short but ALWAYS complete and grammatical (author's law 2a — the kids learn syntax from him). Simple full sentences, present tense; «क!» in call-response is the only fragment allowed. Says **आप** to Papa and Dadi.
...
- **Sample:** «मैं भी बड़ा ड्रैगन हूँ! देखो!»
...
- **Emotion/reason:** loves Kuku; says no from care (a dog is work), not meanness; capable of being wrong and saying so.
- **Vocabulary:** simple; work words (काम).
- **Pace/warmth/tics:** steady, deep; softens visibly at the end.
- **earnsEloquence:** false.
...
- **Emotion/reason:** kind, calm, a little clumsy; proud of Kuku, never competitive.
- **Vocabulary:** simple; big-and-warm words (बड़ा, अच्छा, दोस्त).
- **Directness:** gentle and plain.
- **Pace/warmth/tics:** unhurried, rumbly; makes the big flames Kuku can't — but only ever to help.
- **earnsEloquence:** false.
