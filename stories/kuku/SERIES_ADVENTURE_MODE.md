...
## What's NEW — the adventure machinery

### 1. The team: अक्षर वीर (the Letter Heroes)
The trio + Kalu are the valley's protectors. Each gift is now LOAD-BEARING in action:
- **कुकु** — forges letters (the only one who can). The team's power.
- **फ्यूरिया** — सबसे तेज़: speed, first to the danger.
...
mischief. Motive (soft, sympathetic — Super-Kitties style, never scary): **he can't MAKE letters
of his own, so he steals everyone else's** — a direct mirror of Kuku's Ep1 wound (couldn't make
fire). Bumbling, foiled comically every episode, never hurt; can be invited in at the end and
become a recurring semi-reformed nuisance. Later: a bigger boss if the series wants one.

### 3. The engine: the letter IS the mission
मिटासुर steals the DAY'S LETTER → every word starting with it breaks (this is phonemic awareness
as gameplay: "what stops working without म?"). To fight back the team must LEARN the letter
(Sesame reveal, now MOTIVATED), track मिटासुर, and Kuku FORGES a fresh copy to restore the words
and foil him. Letter of the day = objective = weapon.
...
## New production assets this mode needs
Character sheets: **मिटासुर** (the villain), and per-episode creatures (Ep2: मोर chick + मोरनी).
Same reference-sheet-on-every-render law. मिटासुर never rendered scary — soft, purple, floppy,
googly-eyed, comic.
