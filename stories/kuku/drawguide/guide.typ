...
#page[
  #align(center)[
    ...
    #grid(columns: 3, gutter: 14pt,
      image("sheets/kuku.png", height: 2.5in),
      image("sheets/furia.png", height: 2.5in),
      image("sheets/vesper.png", height: 2.5in))
    #v(0.35in)
    #block(width: 5.6in)[
...
#page[
  ...
  #grid(columns: 5, gutter: 8pt,
    ..(("circle","गोला\nhead"),("oval","अंडा\nbody"),("teardrop","पंख\nwing"),
      ...
      #image("steps/shape_" + p.at(0) + ".png", width: 1.25in)
...
#page[
  ...
  #grid(columns: 4, gutter: 12pt,
    ..(("d3_1","1. सिर्फ़ रेखा","Just the outline — flat."),
      ...
      #image("steps/" + p.at(0) + ".png", width: 1.7in)
      #v(3pt)
    ...
    ..((1, id + "_s1"), (2, id + "_s2"), (3, id + "_s3"),
      ...
      .map(p => block(width: 100%, height: 4.05in, stroke: 0.7pt + rgb("d8c9a0"), radius: 6pt, inset: 5pt)[
        ...
        #align(center + horizon)[#image(
          if p.at(0) == 6 { p.at(1) + ".png" } else { "steps/" + p.at(1) + ".png" },
          height: 3.6in)]
      ]))
]
...
#let tracepage(id, hindi) = page[
  ...
  #v(4pt)
  #align(center)[#image("steps/" + id + "_trace.png", height: 8.4in)]
]
#tracepage("leda", "लेडा")
...
#page[
  #align(center + horizon)[
    ...
    #v(20pt)
    #image("sheets/kuku.png", height: 2.6in)
    #v(14pt)
