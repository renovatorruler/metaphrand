# कुकु और अक्षर — Letter Map (Season 1)
...
ख = «क का बड़ा भाई». The teaching device is the show's own mechanic — **breath**:

> THE FEATHER TEST: Dadi holds a paper feather before Kuku's mouth. क — the feather trembles.
> ख — the feather FLIES. «ख यानी क… और एक बड़ी साँस!» (Kids imitate with palms to mouths —
> real articulatory phonetics, disguised as play.)

Family episodes re-teach the base letter every time (spaced repetition built in). Same pattern:
ग/घ · त/थ · द/ध · प/फ (Furia's spotlight can BE the प/फ family episode — फ needs the extra
...
- Where a letter has a strong body-part word (कान, नाक, दाँत) we prefer it — pointing at your own body is the best preschool mnemonic.
- Season 2 continues the utility order into the remaining consonants, then compound/conjunct letters (क्ष, त्र, ज्ञ) much later.
