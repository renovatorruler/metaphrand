...
const chars = [
  ['husband_mid', 'husband_mid.png', [
    'Three-quarter view from his left, listening with quiet amusement.',
    'Right profile portrait, calm.',
    'Front-facing, laughing, eyes bright.',
    'Three-quarter from his right, serious and gentle.',
  ]],
  ['wife_mid', 'wife_mid.png', [
    'Three-quarter view from her left, faint knowing smile.',
    'Right profile portrait, composed, pallu over head.',
    'Front-facing, laughing warmly.',
    'Three-quarter from her right, thoughtful, soft light.',
  ]],
];
...
const names = { husband_mid: 'Kark Husband Mid', wife_mid: 'Kark Wife Mid' };
for (const [slug, canon, views] of chars) {
