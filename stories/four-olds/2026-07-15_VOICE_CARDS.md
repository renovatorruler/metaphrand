# THE FOUR OLDS — VOICE CARDS + NATAL CHARTS
_Phase 2 artifact · required before any dialogue (pass #7) · the blind-attribution
...
dialogue (flatly repeating the other's word back) banned. Appended-fact tags
banned. Nobody narrates a relationship; nobody says the theme. Radio grammar is
the crew's shared floor — the cards are what make each man distinct ON TOP of it.

**Phase 5 protocol note:** Fountain puts cue and line on separate rows; the gate's
parser wants `KEY: text` one-liners. Run the draft through a two-line join
(cue+dialogue → one line) before `audit()`. Sample lines below double as the
dry-run corpus.

---

## THE ELOQUENCE LEDGER (who earns it — decided here, enforced at the gate)

| register | who | where |
|---|---|---|
| Plain, always | Cricket, Stitch, Mack, Joss, Tito, Danny, Peg, Dutch | everywhere |
| Ritual/borrowed eloquence | Gunny | flag protocol, the Adams grace — the tradition speaks, not him |
| Earned twice, then never | Cricket | the refusal ("You can't give back what you never had"), the finale lines |
| One cold aria | Vess | the Norton-safe scene, three sentences, no adjectives |
| Professional/hollow (satire) | Marwani | every appearance — polish IS the joke |
| Bureaucratic anti-eloquence | Pell | harmony jargon as threat |
| Register snap | Hale | dead hostage-voice for two acts → the detonation |

Rule-of-three is BANNED for every voice except Marwani, for whom it is mandatory
(the TED-triad is the apparatus tell; the satire target carries the AI patterns).
...
**Natal.** Born 1947, Broken Bow, Nebraska; wheat farm; Navy off the farm because
the recruiter came to the county fair. Test pilot, then NASA — backup commander,
the class that never flew. Never processed out (the $0.00 ghost stub). Fifty years
...
vocabulary (nominal, copy, the bird). Silence is a full sentence for him — other
people fill his pauses and he lets them. With Peg: fifty-year shorthand,
half-sentences, jokes worn smooth.
**Tic (leashed).** Answers an emotional question with an operational fact.
("You scared?" / "Suit's holding four-point-one.")
**Eloquence.** Twice, ever — the refusal and the finale. Both arrive AFTER the
audience has waited two hours for him to say anything at all.
**Never.** Self-pity. "Back in my day." Explaining what the mission means.
Rounding a number. Raising his voice.
**Samples.**
CRICKET: Fifty-one years. Every Tuesday. Ask the bank — they've seen the light bill.
CRICKET: I'm current.
CRICKET: Suit's holding four-point-one. Ask me something hard.
CRICKET: Clerical thing. Fifty years now.
CRICKET: You can't give back what you never had.

### WALLACE "DUTCH" HAAS, 76 — `dutch`
**Natal.** Born 1950, West Allis, Wisconsin; machinist's son, Lutheran; tool-and-die
apprentice at fifteen. Apollo systems culture — brazing, torque values, the
document IS the truth. One of Hale's first hires when Frontier was a junkyard;
...
and years the way other men cite scripture. Adjectives distrusted: a thing is
in-spec or it isn't. Corrects units in other people's sentences, including Pell's.
**Tic (leashed).** Names the year of a standard like a vintage. ("That's the '71
spec. Nothing wrong with '71.")
**Eloquence.** None. His poetry is a tolerance held for fifty years.
**Never.** "I think" (he knows or he measures). Hedges. Profanity past "hell."
Blaming a tool.
**Samples.**
DUTCH: The spec says four hundred kilos, nitrogen-purged, independent power. I know what the spec says. I wrote it in 1998 and nobody's improved it since.
DUTCH: If the purge holds — and it holds, I sized the bottle — you've got nine days.
DUTCH: That's not a leak, that's condensation. A leak I'd hear.
DUTCH: Sixty-eight physical. Page eleven. We do all of it or none of it.
DUTCH: Hell. Hand me the three-eighths.

### COL. ELMORE "STITCH" McGREW, 74 — `stitch`
**Natal.** Born 1952, Lufkin, East Texas; crop-duster's kid, flying before
driving. Air Force: SR-71 out of Beale, then shuttle. Flew everything, filed
...
arrives deadpan inside a technical sentence and he never flags it. Rounds every
number ("call it three g's") — the exact inverse of Cricket, by design.
**Tic (leashed).** Catastrophic understatement. ("Sporty." "A little brisk.")
**Eloquence.** Never. When moved he goes quiet and checks something with his hands.
**Never.** A word over three syllables when one will do. Admitting pain.
Exclamation. Asking permission.
**Samples.**
STITCH: Computer says we're fine. Computer said Challenger was fine. I'll keep the slide rule.
STITCH: Call it three g's. Maybe a hair more. Sporty.
STITCH: Kid drives like his mama's watching. Fix that.
STITCH: I flew a Blackbird with a busted gauge and a sandwich. This here's a school bus.
STITCH: Anyway.

### GUNNERY SGT. LEO "GUNNY" TIBBS, 71 — `gunny`
**Natal.** Born 1955, Yemassee, South Carolina — lowcountry; grandfather a
church deacon, father a shrimper. USMC at seventeen; pad crew chief — bossed the
white room while officers borrowed his machine. Owner of the flag protocol and
...
inventive profanity on the shop floor that CUTS OUT DEAD near the flag or the
grace — the clean sentences are how the audience knows they're on holy ground.
Deacon's cadence surfaces when protocol is performed: verbs go formal, King James
word order, borrowed and worn.
**Tic (leashed).** Grill/mess logic applied to orbital mechanics. ("Same as
brisket, son. Low, slow, and don't open the lid.")
**Eloquence.** Ritual only — the flag code, the Adams letter. The tradition
speaks through him; he'd deny owning a single fine word.
**Never.** Irony about the flag or the Corps. Explaining why a thing is sacred.
First names. Profanity within ten feet of the colors.
**Samples.**
GUNNY: You're gonna want to step behind that line, sir. The paint don't care who you monitor.
GUNNY: They've got every algorithm ever written. We've got Valley Forge.
GUNNY: Same as brisket, son. Low, slow, and don't open the lid.
GUNNY: Colonel, you touch my manifest again and I will fold you like the flag — with full honors.
GUNNY: You want 'em? Come through us.
...
### MACK BOONE, 55 — `mack`
**Natal.** Born 1971, Youngstown, Ohio; third-generation steel until the mill
closed his junior year; Army logistics, then twenty years of cargo integration.
...
track of scrap"). Answers questions one size smaller than asked. Logistics
vocabulary for everything, including feelings he declines to have.
**Tic (leashed).** Deflects into scheduling. ("That's a loading question.
Loading's Thursday.")
**Eloquence.** None. The ask at the Legion hall is the plainest big speech ever
written — one photocopied page and a question.
**Never.** Ideology. Stating a motive. A checkable lie. Nervousness in front of
authority.
**Samples.**
MACK: It's a life-support system with a museum sticker on it. Spec was written by a man in this room.
MACK: So. You gentlemen want to go to the Moon?
MACK: I lose track of scrap. County'll tell you. It's a documented deficiency.
MACK: That's a loading question. Loading's Thursday.
MACK: Then this meeting never happened.

### JOSS REED, 26 — `joss`
**Natal.** Born 2000, Mojave, California — airport trash, dad a freight pilot
who taught him CB radio and nothing about caution. Suborbital stunt racer
(unlicensed circuit), day job on Frontier's loading dock. Runs the covert ham
...
by Act 3 he speaks clean radio grammar (the arc is audible). Converts everything
to racing/speed terms. Asks the questions the audience is asking (licensed).
**Tic (leashed).** Race-flag status calls. ("We're still green-flag.")
**Never (by Act 3).** Filler. Cynicism about the mission — his irony is what he
sheds. Never: doubting Cricket's hands.
**Samples.**
JOSS: Okay so this is like — this is literally the coolest felony in history. I'm in. Obviously I'm in.
JOSS: We're still green-flag. Barely. But green.
JOSS: Old dude's resting heart rate embarrassed my watch. My watch cost four hundred dollars.
JOSS: Copy. Net's quiet. Two clicks if it stays that way.
JOSS: No flight plan. Never filed one in my life. Tonight that's a skill.

### TITO ALVAREZ, 24 — `tito`
**Natal.** Born 2002, Boyle Heights, East LA; raised by grandmother LITA
(retired seamstress, García Márquez on the shelf, a Singer older than NASA).
Welding cert at nineteen, fabricator prodigy in Frontier's shop until the
...
Spanish arrives ONLY around family, food, and the flag — placed, never
sprinkled. Youngest-brother deference to the olds; parade-ground formality with
Gunny specifically (military uncles).
**Tic (leashed).** Taps twice on anything he built before he trusts it — and
says so on the radio. ("Tapped twice. She'll hold.")
**Eloquence.** None. The stencils are his speech.
**Never.** Taking credit aloud. Calling his work art. More than one Spanish
phrase per scene. Complaining about the firing.
**Samples.**
TITO: Two fingers of clearance all the way around. She'll hold.
TITO: It's just a good weld. Anybody's good weld. Mine's maybe better.
TITO: Abuela sewed it herself. Fifty-one stars. Don't ask her why fifty-one, she'll tell you.
TITO: Tapped twice. She'll hold.
TITO: Gunnery Sergeant, the stencils are dry. Old ideas rides in front.

### DANNY DAWES, ~50 — `danny`
**Natal.** Born 1976 — the bicentennial, which Cricket never once remarked on,
which tells you everything. Grew up under the barn's light bill; sells ag
...
his sentences shorten toward his father's grammar until the enlistment is four
words ("You need a driver?") — the arc is the compression.
**Tic (leashed).** Buries the lede under a mundane opener. ("Roads are clear.
Dad. Maybe don't watch the news.")
**Never.** Sentimentality spoken TO his father — only sideways, to Peg, to the
truck. Asking Cricket to stop.
**Samples.**
DANNY: Roads are clear at least. Dad. Maybe don't watch the news tonight.
DANNY: I know what's in the barn. I've known a year. I figured you'd tell me when it mattered.
...
they've quit."). Unimpressed by magnitude on principle — the Moon gets the same
register as a church potluck. Dry outlasts everything.
...
### MAGNUS HALE — `hale`
**Natal.** Founder of Frontier — junkyard to the only Moon-capable fleet on
Earth in twenty years. (Musk-ECHO: register and position only; invented
biography; zero real-person claims.) Under Federal Compliance Monitorship: reads
the regime's statements like a hostage tape for two acts; the world calls him a
...
first-principles reflex, absolutes about physics and probabilities about people
("The physics doesn't care. The senator might."). The Act 3 snap is the register
change itself — same man, voltage restored.
**Tic (leashed).** Reduces threats to physics constraints. ("Nationalization is
a policy. Delta-v is a law.")
**Eloquence.** The detonation and the two-word post. Short is his loud.
**Never.** Apologizing in his own words (he only reads apologies). Explaining
the wink he never gives. Pleading.
**Samples.**
HALE: Frontier is proud to serve the goals of the Lunar Heritage Neutralization Accord. (flat, reading)
HALE: The physics doesn't care. The senator might.
HALE: Nationalization is a policy. Delta-v is a law.
HALE: You want to nationalize me? Go. Fuck. Yourself.
HALE: Look up.

### MIRA VESS — `vess`
**Natal.** CEO of Frontier; mother of three of Hale's children; the press sneer
they can't categorize — "the concubine COO" — and she has never once responded.
(Zilis-ECHO: position only; invented person.) PLAYED HATED for ninety minutes:
enforces compliance, paints over the flag, fires the 200, donates the relics,
...
clock). Fiduciary vocabulary: exposure, receiver, continuity. THE AGENCY TELL:
passive voice for everything she's secretly running ("the units were sold for
scrap"), active voice for what she performs publicly ("I ordered the
repainting") — invert a normal liar's grammar; on re-watch the passives map the
conspiracy exactly.
**Tic (leashed).** Answers accusations with corporate schedule facts.
("The board meets Thursday. Bring it.")
**Eloquence.** Once. The safe scene: three sentences, no adjectives.
**Never.** Raising her voice. Defending herself. Explaining before the safe
scene. The word "sorry."
**Samples.**
VESS: The company will comply. Fully, publicly, and on schedule.
VESS: Two hundred positions were eliminated. The units were sold for scrap. Auditors had full access.
VESS: I ordered the repainting. Paint is cheaper than a receiver. That math is my job.
VESS: The board meets Thursday. Bring it.
VESS: You wanted the company to cooperate. The company cooperated. The country didn't.

### ADMINISTRATOR PELL — `pell`
**Natal.** The Federal Harmony Monitor — the movie's warden; a county tax
assessor's soul promoted to orbit. Laminated harmony quotes on his lanyard;
personally rode the seizure of a barn simulator on a county lien. Gets ONE real
...
power: folks, little shop, this operation of yours. Mispronounces one technical
term per appearance and plows on (apparatus comedy — the joke is on HIM, never
on procedure itself; the weigh-in shows him briefly, horribly competent).
**Tic (leashed).** Laminated-quote deployment. ("As the Accord reminds us:
harmony is a verb.")
**Eloquence.** Anti. His biggest scene is signatures in silence.
**Never.** Profanity. Admitting uncertainty. Physical courage. Skipping a form.
**Samples.**
PELL: I'm sensing non-alignment, gentlemen. Section fourteen has a word for that.
PELL: As the Accord reminds us: harmony is a verb.
PELL: It's a routine re-weigh, folks. Routine is what I do.
PELL: Four crates. Heavy. Together, and I want to say this precisely, heavy-ER.
PELL: This little shop of yours has a paperwork smell. I have a nose for paperwork.

### PRESIDENT MARWANI, 41 — `marwani` (SCREENS ONLY)
**Natal.** Youngest president ever; DSA-affiliated; Nobel Peace Prize for
ANNOUNCING his agenda. (Mamdani-ECHO: cadence and position only; invented
biography.) Exists in the film exclusively on screens — podiums, PSAs, one
...
applause line). TED-TRIADS MANDATORY — he is the one voice in the film built
from the banned patterns (rule-of-three, negative parallelism "not just X but
Y"): the AI-slop cadence IS the satire, quarantined in him. Never answers a
question; answers the question he brought.
**Tic (structural, unleashed — he's a broadcast).** Apology as flex.
**Never.** "America" without a softening qualifier ("a humbler America"). A
direct answer. Contractions. Anger.
**Samples.**
...
MARWANI: We inherited a flag on the Moon. We choose to leave a hand extended.
MARWANI: A humbler America is a stronger America, a kinder America, a truer America.
MARWANI: I hear the anger. I honor the anger. I am asking the anger to grow.

---

## BLUR-RISK TABLE (the confusions the gate must watch)

| pair | shared floor | the separator (mechanical, checkable) |
|---|---|---|
| cricket ↔ stitch | laconic old pilots | Cricket NEVER rounds a number; Stitch ALWAYS rounds. Cricket zero jokes; Stitch's deadpan rides inside technical sentences. |
| dutch ↔ gunny | procedure men | Dutch cites specs/years, zero profanity; Gunny cites protocol/rank, fluent profanity that dies near the flag. |
| joss ↔ tito | the kids | Joss = speed metaphors + filler (burning off); Tito = craft metaphors + praise-deflection, object-as-subject. |
| hale ↔ vess | the towers | Hale = physics absolutes, staccato; Vess = fiduciary calm, passive/active agency tell. |
| pell ↔ marwani | the apparatus | Pell = section numbers + diminutives, small; Marwani = triads + we-apologies, cosmic. |
| mack ↔ dutch | plain competence | Mack answers one size smaller than asked, schedule deflection; Dutch answers one size LARGER (conditions discharged). |
| danny ↔ joss | younger voices | Danny buries ledes under weather, sentences shortening film-long; Joss leads with status calls, filler shedding. |

## GATE SETUP (Phase 2 exit + Phase 5 rerun)
- Harness: `metaphrand.blind_attribution` (audit/report/gate), OllamaClient
  json_mode, local model per build env.
- Keys = the backticked slugs above; Fountain cues map 1:1 (single-word, no
  alias table needed; `MARWANI (V.O.)` etc. strip to the word before the paren).
- **Dry run (now):** feed the sample lines above as the calibration script —
  cards as key, samples as corpus. If the gate can't tell designed lines apart,
  the cards are blurred at birth: fix cards, not later dialogue.
- **Real run (Phase 5):** full Fountain → cue-join adapter → `gate()` at
  threshold 0.70, max confused pair 3. Receipts into the finishing report.

---

## 2026-07-15 ADDENDUM — BRANDT (the normal pole, carded for the satirical rework)

### CMDR. SØREN BRANDT, 54 — `brandt`
**Natal.** Born 1972, Aarhus, Denmark; harbor pilot's son. Danish air force,
then ESA — the man who tests the procedures other men get famous flying.
Twenty-two years of exemplary, unphotographed service. Chosen to retrieve the
flags precisely because he has no opinions on television.
**Chart.** Sun Virgo (procedure as devotion), Moon Capricorn (feeling arrives
as duty, contained), Mars Libra (acts only when the scales demand it), Mercury
Virgo (checklists; asks questions instead of stating feelings), Saturn in the
tenth (the weight of orders carried without comment).
**Voice mechanics.** Precise, unhurried, fluent second-language English — the
grammar perfect, the idiom slightly formal ("I am not certain this is
correct procedure"). Short declaratives. Care arrives dressed as procedure:
"State your oxygen margin" is his I'm-worried-about-you.
**Tic (leashed).** Converts any feeling into a procedural question.
**Never.** Never raises his voice. Never editorializes on politics — his
silence IS the middle pole. Never touches the flags on camera.
**Earned break (once, the climax).** Four plain words, off-script, watching a
man grill on the Moon: "Where did you come from?" — the film's sanest voice
finally asking the film's realest question.
**Sample lines (blind-attribution corpus).**
`brandt`: I am instructed to proceed. I have not yet decided if I am able.
`brandt`: State your oxygen margin, please. Then we will discuss the sandwich.
`brandt`: This is not in my checklist. Nothing today is in my checklist.

**Eloquence ledger row:** Plain, always — one earned break of four words at
the cookout.
